...
public class ShowNameProd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_name_prod);
        setTitle("Product by name");
        //
    ...
    public void buttonClick(View view) {
        ...
        userCursor =  db.rawQuery("select * from "+ DataBaseHelper.TABLE + " where " + DataBaseHelper.COLUMN_NAME + "='" + name + "'", null);
        ...
        userList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(ShowNameProd.this, EditProductMenu.class);
