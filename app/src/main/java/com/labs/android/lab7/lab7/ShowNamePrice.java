...
public class ShowNamePrice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_name_price);
        setTitle("Product name price");
        //
    ...
    public void buttonClick(View view) {
        ...
        EditText editTextPrice = (EditText) findViewById(R.id.editText3);
        String name = editText.getText().toString();
        Double priceSet = Double.parseDouble(editTextPrice.getText().toString());

        db = databaseHelper.getReadableDatabase();
        userCursor =  db.rawQuery("select * from "+ DataBaseHelper.TABLE + " where " + DataBaseHelper.COLUMN_NAME + "='" + name + "' and " + DataBaseHelper.COLUMN_PRICE + "<" + priceSet, null);
        ...
        userList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(ShowNamePrice.this, EditProductMenu.class);
